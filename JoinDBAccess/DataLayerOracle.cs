...
{
    /// <summary>
    /// Implement with .NET Framework Data Provider for Oracle.
    /// </summary>
    internal class DataLayerOracle : DataLayerBase
    {
        /// <summary>
        /// Initializes a new instance of the DataLayerOracle class.
        /// </summary>
        public DataLayerOracle()
            : base(DatabaseTypes.Oracle, new OracleConnection(), ":"
