...
{
    /// <summary>
    /// Implement a wrapped of Firebird SQL server
    /// </summary>
    internal class DataLayerFirebird : DataLayerBase
    {
        /// <summary>
        /// Initializes a new instance of the  class.
        /// </summary>
        public DataLayerFirebird()
            : base(DatabaseTypes.Firebird, new FbConnection(), "@"
            , new ConnectionParameterNames(string.Empty, "Server", "Database", "User", "Password"))
        {        }
        ...
        {
            return new FbDataAdapter((FbCommand)dbCommand);
        }
